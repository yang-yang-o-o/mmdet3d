...
# from ...core import bbox3d2result_faw, show_multi_modality_result_faw
from ..builder import DETECTORS, build_backbone, build_head, build_neck


@DETECTORS.register_module()
class SingleStageMono3DDetector_faw(SingleStageDetector):
    """Base class for monocular 3D single-stage MODELS.

    Single-stage MODELS directly and densely predict bounding boxes on the
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        x = self.extract_feat(img)
        # mmcv.dump(img.cpu().numpy().tolist(), "/mnt/lustre/share_data/chenxuepan/workspace/Hozon/other/hozon_deploy_align/torch_output/img_from_json.json")
...
def bbox3d2result_faw(bboxes, scores, labels, attrs=None, bbox2d=None):
    ...
    if bbox2d is not None:
        result_dict['bboxes_2d'] = bbox2d.cpu()
