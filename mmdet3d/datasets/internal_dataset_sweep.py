...
from mmdet3d.core.evaluation.prd_evaluator import PRDEvaluator
...
class InternalDatasetSweep(Custom3DDataset):
    ...
    def __init__(self,
        ...
        if hasattr(self.file_client, 'get_local_path'):
            with self.file_client.get_local_path(self.ann_file) as local_path:
                self.data_infos = self.load_annotations(open(local_path, 'rb')) # 按时间戳排序
        else:
            warnings.warn(
        ...
        # self.cams = ['center_camera_fov120', 'left_front_camera', 'left_rear_camera',\
        #              'rear_camera', 'right_rear_camera', "right_front_camera"]
    ...
    def get_data_info(self, index):
        ...
        if self.modality['use_camera']:
            ...
            for cam_type, cam_info in info['cams'].items():
                ...
                extrinsics.append(extrinsic.T) # center2cam.T
            ...
            input_dict.update(
                dict(
                    ...
                    lidar2img=lidar2img_rts, # center2img
                    intrinsics=intrinsics,
                    extrinsics=extrinsics # center2cam.T
                ))
    ...
    def get_ann_info(self, index):
        ...
        gt_bboxes_3d = np.concatenate([gt_bboxes_3d, gt_velocity] , axis=-1) # x,y,z,l,w,h,θ,vx,vy
        ...
        gt_labels_3d = np.array(gt_labels_3d) # gt_label
        
        gt_bboxes_3d = LiDARInstance3DBoxes( # gt_box_3d
            gt_bboxes_3d,
            box_dim=gt_bboxes_3d.shape[-1],
            origin=(0.5,0.5,0.5)).convert_to(self.box_mode_3d)
        
        anns_results = dict(
            gt_bboxes_3d=gt_bboxes_3d, # x,y,z,l,w,h,θ,vx,vy
    ...
    def evaluate(self, outputs, **eval_kwargs):
        internal_evaluator = PRDEvaluator(self.data_infos, outputs, self.point_cloud_range)
        eval_results = internal_evaluator.evaluate_internal_data()
        return eval_results
